			...
			<div class='row' style='min-height:520px'>
				<div class='col-md-12'>
					...
					<?php
						...
						$sqlquery = "SELECT * FROM buah WHERE kode_buah='$kode_buah'";
						$result = mysqli_query($koneksi, $sqlquery) or die (mysqli_connect_error());
						$row = mysqli_fetch_assoc($result);
						?>

					<div class='panel panel-success'>
						<div class='panel-heading'>Edit Data Buah</div>
						<div class='panel-body'>
							<form method='post' action='aksi_buah.php?act=update'>
								<div class='form-group'>
								<input type="hidden" name="kode_buah" id="kode_buah" value="<?php echo $row["kode_buah"]; ?>">
									<label>Jenis Buah</label>
									<input type='text' class='form-control' name='jenis_buah' value="<?php echo $row["jenis_buah"]; ?>" required/>
								</div>
								<div class='form-group'>
