			...
			<div class='row' style='min-height:520px'>
				<div class='col-md-12'>
					<div class='panel panel-success'>
						<div class='panel-heading'>Tambah Data Buah</div>
						<div class='panel-body'>
							<form method='post' action='aksi_buah.php?act=input'>
								<div class='form-group'>
									<label>Jenis Buah</label>
									<input type='text' class='form-control' name='jenis_buah' required/>
								</div>
								<div class='form-group'>
